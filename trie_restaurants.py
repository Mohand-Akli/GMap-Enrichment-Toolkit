...
# chrome_options.add_argument("--headless") # Décommente cette ligne si tu ne veux pas voir la fenêtre s'ouvrir
...
try:
  for idx, row in df.iterrows():
    ...
    choix = (
        input(
            "Voulez-vous garder ce restaurant ? ([g]arder / [s]upprimer /"
            " [q]uitter) : "
        )
        .strip()
        .lower()
